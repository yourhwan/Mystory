                                ...
                                if (answer112 == 1) { // 10만원대
                                    ...
                                    if (answer113 == 1) { // 뿔테
                                        ...
                                        System.out.println("찾기 힘든 상하 폭이 좁은 안경테를 좋아하는 백수 오윤환, 마음에 쏙 드는 안경테를 발견했다." +
                                                "\n뿔테보다 가격은 조금 더 있지만 10만원대에 일본생산 그리고 직선적이고 각진 디자인이 마음에 들었던 백수 오윤환은 하금테를 구매하기로 결정한다.");
                                    ...
                                    if (answer114 == 1) { // 향수
                                        ...
                                        if (answer116 == 1) { // 먹고 공부
                                            ...
                                            if (answer118 == 1) { // 집
                                                System.out.println("다시 마음을 다잡고 공부를 시작하는 백수 오윤환, 다행히도 금새 집중을 할 수 있었다. 사뭇 진지한 모습으로 공부를 하는 모습이 오랜만이다.");
