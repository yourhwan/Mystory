...
public class Ohday {
   // public static void main(String[] args) {} // 메인스레드 하나는 동기를 담당
    // 스레드의 동기는 또 큐라고 한다.
        ...
        if (answer1 == 1) {
            ...
            if (answer2 == 1) {
                ...
                if (answer3 == 1) { // 다시 취침
                        ...
                        if (answer12 == 1) { // 트위치 보기
                            ...
                            if (answer27 == 1) { // 신전 떡볶이
                                ...
                                if (answer58 == 1) { // 카페에서 공부
                                    ...
                                    System.out.println("\nQ.카페에 도착해서 본격적으로 공부를 시작하는 백수 오윤환, 오늘은 몇시간 공부를 하고 돌아갈까?" +
                                            "\n1.8시간    2.10시간");

                                    int answer160 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer160 >= 1 && answer160 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer160 == 0) {
                                            System.out.println(answer160 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer160 = sc.nextInt();
                                        }
                                    }

                                    if (answer160 == 1) { // 8시간
                                        System.out.println("카페에서 공부를 하면 집중이 잘 된다. 알고리즘 공부 부터 시작해 인프런 강의를 보면서 스프링 공부를 하는 백수 오윤환." +
                                                "\n오랜만에 최대 집중력을 발휘해서 끝까지 공부를 하고 집에 돌아간다.");
                                        System.out.println("최근 취업 때문에 걱정이 많아진 만큼 취업준비에 더욱 집중을 하려는 백수 오윤환, 매일 오늘과 같이 생활할 수 있기를!" +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                        ...
                                        System.out.println("카페에서 공부를 하면 집중이 잘 된다. 알고리즘 공부 부터 시작해 인프런 강의를 보면서 스프링 공부를 하는 백수 오윤환." +
                                                "\n오랜만에 최대 집중력을 발휘해서 공부를 하지만 8시간만 채우고 체력이 부족해서 집에 돌아간다.");
                                        System.out.println("최근 취업 때문에 걱정이 많아진 만큼 취업준비에 더욱 집중을 하려는 백수 오윤환, 체력도 더 길러서 매일 오늘과 같이 생활할 수 있기를!" +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("\nQ.앞으로 조금씩이라도 기초체력 운동을 하기로 결심한 백수 오윤환, 남은 하루는 공부로 채우려고 한다. 어떤 공부를 할까?" +
                                            "\n1.알고리즘 공부    2.인프런 강의를 보며 공부");

                                    int answer161 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer161 >= 1 && answer161 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer161 == 0) {
                                            System.out.println(answer161 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer161 = sc.nextInt();
                                        }
                                    }

                                    if (answer161 == 1) { // 알고리즘 공부
                                        System.out.println("가장 쉬운 단계의 알고리즘 부터 풀기 시작해서 차근차근 난이도를 올려가면서 공부를 하는 백수 오윤환, 잘 풀리지 않거나 모르는 문제는 다른 사람들의 풀이를 참고하고" +
                                                "\n다시 직접 풀어본 뒤 블로그에 정리하는 방식으로 공부를 한다. 이렇게 남은 하루를 모두 공부에 투자한 백수 오윤환, 내일은 강의를 보며 프로젝트를 만들어볼 계획도 세웠다." +
                                                "\n알차게 공부를 하고 하루를 마무리하니 기분이 좋은 백수 오윤환, 내일도 오늘과 같이 공부를 열심히 할 수 있기를!" +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    }
                                    else { // 인프런 강의를 보며 공부
                                        System.out.println("Spring 프로젝트를 만드는 것 부터 Spring 프로젝트 환경에 대한 이해와 코드의 적용 등을 꼼꼼히 공부하는 백수 오윤환" +
                                                "\n강의에서 본 내용을 직접 적용해본 뒤 블로그에 정리하는 방식으로 공부를 한다. 이렇게 남은 하루를 모두 공부에 투자한 백수 오윤환, 내일은 알고리즘 공부를 할 계획도 세웠다." +
                                                "\n알차게 공부를 하고 하루를 마무리하니 기분이 좋은 백수 오윤환, 내일도 오늘과 같이 공부를 열심히 할 수 있기를!" +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                ...
                                if (answer59 == 1) { // 독서
                                    ...
                                    System.out.println("\nQ.우주과학을 좋아하기 때문에 한번에 완독을한 백수 오윤환, 여운이 가시지 않아 우주와 관련된 무언가를 더 보고싶다. 어떤 것을 볼까? " +
                                            "\n1.우주과학 유튜브    2.영화 인터스텔라");

                                    int answer162 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer162 >= 1 && answer162 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer162 == 0) {
                                            System.out.println(answer162 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer162 = sc.nextInt();
                                        }
                                    }

                                    if (answer162 == 1) { // 우주과학 유튜브
                                        System.out.println("평소 우주과학 유튜브를 정말 자주 보는 백수 오윤환, 코스모스를 완독한 후의 여운을 이어가고자 우주과학 유튜브를 본다." +
                                                "\n책도 읽고 유튜브도 보며 우주에 관한 것으로 하루를 가득 채운 백수 오윤환, 동심으로 되돌아간 것만 같은 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    }
                                    else { // 영화 인터스텔라
                                        System.out.println("우주하면 바로 떠오르는 대표적인 영화인 인터스텔라를 보는 백수 오윤환, 이미 봤던 적이 있지만 그동안 쌓은 지식을 배경으로 다시 보니" +
                                                "\n이해가 안됐던 것들이 보여 더욱 재미있게 영화를 볼 수 있었다. 오늘 하루를 우주에 관한 것으로 가득 채운 백수 오윤환, 동심으로 돌아간 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("오늘 만큼은 공부를 해야겠다는 의지를 불태우는 백수 오윤환, 책상 앞에 앉아 공부할 준비를 한다.");
                                    System.out.println("\nQ.오늘은 인프런 강의를 보며 공부를 하려는 백수 오윤환, 오늘의 목표는?" +
                                            "\n1.3강    2.4강");

                                    int answer163 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer163 >= 1 && answer163 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer163 == 0) {
                                            System.out.println(answer163 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer163 = sc.nextInt();
                                        }
                                    }

                                    if (answer163 == 1) { // 3강
                                        System.out.println("3강의 분량을 보면서 공부를 하는 백수 오윤환, 수업을 들으며 코드도 따라서 쳐보고 강의가 끝난 후에는 다시 혼자 해보며 공부를 한다." +
                                                "\n이후에는 공부한 내용을 블로그에 자세히 기록하며 정리하는 백수 오윤환, 이러한 방법으로 계속 반복한다면 분명히 실력이 많이 상승한다고 한다." +
                                                "\n남은 하루를 공부에 대한 열정으로 가득 채우니 뿌듯한 마음과 동시에 내일도 오늘과 같이 공부할 생각에 벌써 힘이 드는 것 같다." +
                                                "\n하지만 앞으로 성장할 본인의 모습이 기대가 되는 백수 오윤환, 오늘 남은 하루를 꿈으로 가득 채운 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    }
                                    else { // 4강
                                        System.out.println("4강의 분량을 보면서 공부를 하는 백수 오윤환, 수업을 들으며 코드도 따라서 쳐보고 강의가 끝난 후에는 다시 혼자 해보며 공부를 한다." +
                                                "\n이후에는 공부한 내용을 블로그에 자세히 기록하며 정리하는 백수 오윤환, 이러한 방법으로 계속 반복한다면 분명히 실력이 많이 상승한다고 한다." +
                                                "\n오늘따라 공부가 잘 됐는지 총 5강 분량의 공부를 마친 백수 오윤환." +
                                                "\n남은 하루를 공부에 대한 열정으로 가득 채우니 뿌듯한 마음과 동시에 내일도 오늘과 같이 공부할 생각에 벌써 힘이 드는 것 같다." +
                                                "\n하지만 앞으로 성장할 본인의 모습이 기대가 되는 백수 오윤환, 오늘 남은 하루를 꿈으로 가득 채운 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                            ...
                            if (answer28 == 1) { // 동네 카페
                                ...
                                if (answer60 == 1) { // 커피
                                    ...
                                    System.out.println("\nQ.카페에서 커피를 마시며 엄마와 이야기를 나누는 백수 오윤환, 즐거운 시간을 보낸 뒤 집에 돌아가려 하는데, 엄마가 마트로 장을 보러 간다고 한다. 같이 갈까?" +
                                            "\n1.집에 간다    2.같이 간다");

                                    int answer164 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer164 >= 1 && answer164 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer164 == 0) {
                                            System.out.println(answer164 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer164 = sc.nextInt();
                                        }
                                    }

                                    if (answer164 == 1) { // 집에 간다
                                        System.out.println("귀차니즘이 발동한 백수 오윤환, 엄마에게 집에 간다고 하니 흔쾌히 알겠다고 말하며 먹고싶은 것이 있냐고 물어본다." +
                                                "\n마음이 약해지는 백수 오윤환, 결국 엄마와 같이 마트에 가서 장을 본 뒤 집으로 돌아온다." +
                                                "\n막상 함께 마트에 다녀오니 잘 했다는 생각이 든 백수 오윤환, 엄마와 몇년만에 함께 장도 보니 옛날 어린시절 추억이 새록새록했다." +
                                                "\n엄마와 자주 시간을 보내야겠다는 생각을 한 백수 오윤환, 오늘 하루는 엄마와 함께 보내서 마음이 따듯한 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    }
                                    else { // 같이 간다
                                        System.out.println("엄마와 데이트를 하기로 마음 먹었던 하루인 만큼 함께 마트로 향하는 백수 오윤환." +
                                                "\n정말 오랜만에 엄마와 같이 마트에 가서 장을 본 뒤 집으로 돌아온다." +
                                                "\n장을 보는 내내 함께 마트에 오기를 잘 했다는 생각이 들었던 백수 오윤환, 엄마와 몇년만에 함께 장도 보니 옛날 어린시절 추억이 새록새록했다." +
                                                "\n엄마와 자주 시간을 보내야겠다는 생각을 한 백수 오윤환, 오늘 하루는 엄마와 함께 보내서 마음이 따듯한 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("\nQ.카페에서 엄마와 많은 이야기를 나누는 백수 오윤환, 즐거운 시간을 보낸 뒤 집에 돌아가려 하는데, 엄마가 마트로 장을 보러 간다고 한다. 같이 갈까?" +
                                            "\n1.집에 간다    2.같이 간다");

                                    int answer165 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer165 >= 1 && answer165 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer165 == 0) {
                                            System.out.println(answer165 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer165 = sc.nextInt();
                                        }
                                    }

                                    if (answer165 == 1) { // 집에 간다
                                        System.out.println("귀차니즘이 발동한 백수 오윤환, 엄마에게 집에 간다고 하니 흔쾌히 알겠다고 말하며 먹고싶은 것이 있냐고 물어본다." +
                                                "\n마음이 약해지는 백수 오윤환, 결국 엄마와 같이 마트에 가서 장을 본 뒤 집으로 돌아온다." +
                                                "\n막상 함께 마트에 다녀오니 잘 했다는 생각이 든 백수 오윤환, 엄마와 몇년만에 함께 장도 보니 옛날 어린시절 추억이 새록새록했다." +
                                                "\n엄마와 자주 시간을 보내야겠다는 생각을 한 백수 오윤환, 오늘 하루는 엄마와 함께 보내서 마음이 따듯한 하루였다." +
                                ...
                                if (answer61 == 1) { // 커피
                                    System.out.println("달달한 커피가 마시고싶던 백수 오윤환, 엄마와 함께 지하에 있는 스타벅스로 가서 커피를 마시며 이야기를 나눈다.");
                                    System.out.println("\nQ.스타벅스에서 꽤나 시간을 보낸 뒤 백화점 구경을 하는 백수 오윤환과 엄마, 오늘 저녁을 먹고 들어갈까?" +
                                            "\n1.먹고 간다    2.그냥 간다");

                                    int answer166 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer166 >= 1 && answer166 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer166 == 0) {
                                            System.out.println(answer166 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer166 = sc.nextInt();
                                        }
                                    }

                                    if (answer166 == 1) { // 먹고 간다
                                        System.out.println("엄마와 오랜만에 즐거운 시간을 보내는 만큼, 저녁은 외식을 하기로 결심한 백수 오윤환. 엄마는 비싸다며 만류하지만 이 시간이 사뭇 즐거운지 평소보다 표정이 밝아 보인다." +
                                                "\n엄마와 저녁식사까지 마치고 집에 돌아온 백수 오윤환, 몇년만에 엄마와 풀코스로 밖에서 시간을 보내니 어린시절이 생각이나며 마음이 몽글몽글해진 하루였다." +
                                                "\n앞으로도 엄마와 종종 이런 시간을 보내야겠다고 결심한 백수 오윤환, 취업을 해서 엄마가 좋아하는 것을 마음껏 해드리고싶은 마음이 더 간절해진 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    }
                                    else { // 그냥 간다
                                        System.out.println("지갑사정 때문에 집에 가서 먹으려고 했지만 오랜만에 함께 나온만큼 엄마와 맛있는 밥을 먹고 들어가기로 마음을 고쳐먹은 백수 오윤환, 알바 한번 더 하면된다는 마인드다." +
                                                "\n엄마는 비싸다며 만류하지만 이 시간이 사뭇 즐거운지 평소보다 표정이 밝아 보인다." +
                                                "\n엄마와 저녁식사까지 마치고 집에 돌아온 백수 오윤환, 몇년만에 엄마와 풀코스로 밖에서 시간을 보내니 어린시절이 생각이나며 마음이 몽글몽글해진 하루였다." +
                                                "\n앞으로도 엄마와 종종 이런 시간을 보내야겠다고 결심한 백수 오윤환, 취업을 해서 엄마가 좋아하는 것을 마음껏 해드리고싶은 마음이 더 간절해진 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("오랜만에 백화점에 온 백수 오윤환, 살 것은 없지만 엄마와 아이쇼핑 하는 것을 좋아했었기 때문에 백화점 구경을 먼저 하기로 한다.");
                                    System.out.println("\nQ.구경을 하던 중 엄마가 마음에 드는 청바지가 있는듯 자꾸만 만져본다. 엄마에게 선물을 해드릴까?" +
                                            "\n1.선물 해드린다    2.아쉽지만 다음에 해드린다");

                                    int answer167 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer167 >= 1 && answer167 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer167 == 0) {
                                            System.out.println(answer167 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer167 = sc.nextInt();
                                        }
                                    }

                                    if (answer167 == 1) { // 선물 해드린다
                                        System.out.println("집안 사정이 힘들어지며 몇년 동안 옷을 사본적이 없는 엄마, 백수 오윤환은 늘 이 부분이 마음에 걸렸었다." +
                                                "\n오늘은 엄마와 데이트를 하는 날이니 만큼 엄마에게 선물을 해드린다. 미안해 하면서도 내심 좋아하는 엄마의 모습을 보니 마음이 좋지만은 않은 백수 오윤환." +
                                                "\n집에 돌아와 그 때를 곱씹어보며 얼른 취업을 해서 엄마에게 좋은 것들을 더 많이 해드려야겠다는 결심을 하는 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                        ...
                                        System.out.println("집안 사정이 힘들어지며 몇년 동안 옷을 사본적이 없는 엄마, 백수 오윤환은 늘 이 부분이 마음에 걸렸었다." +
                                                "\n오늘은 엄마와 데이트를 하는 날이니 만큼 엄마에게 선물을 해드리고싶지만, 지갑사정이 여의치 않다. 괜찮다는 엄마의 모습을 보니 마음이 미어지는 백수 오윤환." +
                                                "\n집에 돌아와 그 때를 곱씹어보며 얼른 취업을 해서 엄마에게 좋은 것들을 더 많이 해드려야겠다는 결심을 하는 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                        ...
                        if (answer14 == 1) { // 집에서 공부
                            ...
                            if (answer32 == 1) { // 카페에서 공부
                                ...
                                if (answer66 == 1) { // 카페로 오라고 한다
                                    ...
                                    System.out.println("\nQ.친구와 함께 카페에서 공부를 하던 중 친구가 자신이 살테니 맥주를 마시러 가자고 한다. 고민이 되는 백수 오윤환, 어떻게 할까?" +
                                            "\n1.간다    2.안간다");

                                    int answer168 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer168 >= 1 && answer168 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer168 == 0) {
                                            System.out.println(answer168 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer168 = sc.nextInt();
                                        }
                                    }

                                    if (answer168 == 1) { // 간다
                                        System.out.println("정말 오랜만에 만나기도 했고 공부도 꽤나 오래했다고 판단한 백수 오윤환, 심지어 친구가 산다고 하는데 어떻게 뿌리치겠는가?" +
                                                "\n맥주집으로 가서 친구와 추억도 회상하고 요즘 어떻게 지내는지 이야기 보따리를 푼다.");
                                        System.out.println("\nQ.기분 좋게 적당히 마신 백수 오윤환과 친구, 친구가 2차를 가자고 제안한다. 어떻게 할까?" +
                                                "\n1.간다    2.안간다");

                                        int answer169 = sc.nextInt();

                                        for (; ; ) {

                                            if (answer169 >= 1 && answer169 <= 2) {
                                                break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                            } else if (answer169 == 0) {
                                                System.out.println(answer169 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                sc.close();
                                                return;
                                            } else {
                                                System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                answer169 = sc.nextInt();
                                            }
                                        }

                                        if (answer169 == 1) { // 간다
                                            System.out.println("오늘 오랜만에 만나서 노는김에 2차까지 가는 백수 오윤환과 친구, 깊은 새벽까지 이야기를 나누며 술잔을 기울인다." +
                                                    "\n오랜만에 만난 친구와 즐거운 시간을 보내고 내일을 살아갈 에너지를 충전한 백수 오윤환이었다." +
                                                    "\n-THE END-");
                                            sc.close(); // 프로그램 종료

                                        } else { // 안간다
                                            System.out.println("너무 가고싶지만 내일 일정을 위해 각자의 집으로 돌아가는 백수 오윤환과 친구, 다음을 기약하며 헤어진다." +
                                                    "\n나름 공부도 하고 친구도 만나고 나쁘지만은 않은 하루였다." +
                                                    "\n-THE END-");
                                            sc.close(); // 프로젝트 종료
                                        ...
                                        System.out.println("오늘은 카페 마감까지 공부를 할 계획이었던 백수 오윤환, 아쉽지만 친구에게 술은 다음에 마시자고 이야기하고 다시 공부에 집중한다." +
                                                "\n그렇게 마감까지 공부를 한 백수 오윤환, 스스로 대견함을 느끼며 하루를 마무리 한다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("카페에서 마감때 까지 집중해서 공부를 한 백수 오윤환, 이렇게 하루종일 집중해서 공부를 한 것은 정말 오랜만이다." +
                                            "\n오늘따라 성취감이 컷는지 내일은 더 많이 공부하기로 결심한 백수 오윤환, 뿌듯한 마음으로 오늘 하루를 마무리한다." +
                                            "\n-THE END-");
                                    sc.close(); // 프로그램 종료
                                }
                            } else { // 잠시 휴식
                                ...
                                if (answer67 == 1) { // 연락을 해본다
                                    ...
                                    System.out.println("취업에 대한 정보와 각자가 겪고있는 그리고 겪었던 어려움을 공유하고 공감대를 형성하는 백수 오윤환" +
                                            "\n취업한 사람과 이런저런 이야기를 나누다보니 의욕이 불타올라 다시 공부에 집중을 한다. 그렇게 하루종일 공부를 한 백수 오윤환" +
                                            "\n남들보다 취업이 늦는 만큼 더 좋은 곳에 가겠다는 의지가 불타오른 하루였다." +
                                            "\n-THE END-");
                                    sc.close(); // 프로그램 종료
                                } else { // 연락하지 않는다
                                    System.out.println("자신의 현재 모습이 부끄러운지 연락하기가 고민스러운 백수 오윤환, 결국 연락을 하지 않고 홀린듯 침대로 기어 들어간다.");
                                    System.out.println("그동안의 설움과 힘듦 그리고 자신의 모습이 부끄러운 백수 오윤환, 이불 속에서 오만가지 감정을 곱씹으며 울다가 무기력하게 하루를 흘려보낸다." +
                                            "\n평소 약한 모습을 스스로에게도 감추었던 백수 오윤환, 어쩌면 이런 날이 필요했을 수도 있지 않을까? 이대로 무너질 오윤환은 아니기 때문에 더 나은 내일을 기대할 수 있다." +
                                            "\n-THE END-");
                                    sc.close(); // 프로그램 종료
                                }
                            }
                            ...
                            if (answer33 == 1) { // 스타벅스
                                ...
                                if (answer68 == 1) { // 인사를 한다
                                    System.out.println("성격상 먼저 인사를 잘 안 하는 백수 오윤환, 사람이 그리웠는지 친구들에게 다가가 먼저 인사를 나눈다.");
                                    System.out.println("\nQ.생각보다 반갑에 인사를 나누는 백수 오윤환과 친구들, 인사를 나눈 뒤 자리로 돌아와 공부를 하는 백수 오윤환, 오늘은 몇시까지 공부를 할까?" +
                                            "\n1.저녁식사 전까지     2.카페 마감까지");

                                    int answer170 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer170 >= 1 && answer170 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer170 == 0) {
                                            System.out.println(answer170 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer170 = sc.nextInt();
                                        }
                                    }

                                    if (answer170 == 1) { // 저녁식사 전까지
                                        System.out.println("저녁식사 전까지 집중을 해서 공부를 하는 백수 오윤환, 공부를 마치고 집에 돌아온다.");
                                        System.out.println("집에 돌아온 백수 오윤환, 카페에서 만난 친구들은 모두 취업을 한 친구들인 것을 알고 있었다." +
                                                "\n본인의 처지가 처량하다고 느꼈는지 집에 와서도 밥을 먹지 않고 이어서 공부를 한다." +
                                                "\n취업에 성공해서 누구보다 자신에게 떳떳한 사람이 되겠다는 의지를 갖고 남은 하루를 공부로 불태운다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    } else { // 카페 마감까지
                                        System.out.println("배가 고픈지도 모른채 집중해서 카페 마감까지 공붑를 하고 집으로 돌아가는 백수 오윤환, 다시 마음을 다잡은 거 같다.");
                                        System.out.println("집에 돌아와서도 밥을 먹지 않고 공부를 계속 하는 백수 오윤환, 카페에서 마주친 친구들이 승무원에 합격한 사실을 알고 있었다." +
                                                "\n승무원의 꿈을 저버리고 다른 꿈을 꾸고 있는 자신에게 후회하지 않기 위해 마음을 다잡으며 공부로 남은 하루를 보낸다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    }
                                } else { // 모른척 한다
                                    System.out.println("굳이 인사할 필요가 없다고 생각이 든 백수 오윤환, 원래 성격대로 그냥 모른체하며 공부를 시작한다.");
                                    System.out.println("\nQ.집중해서 공부를 하는 백수 오윤환, 중간에 고개를 들었는데 친구들과 눈이 마주쳤다. 인사를 할까?" +
                                            "\n1.인사한다    2.못알아본척한다");

                                    int answer171 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer171 >= 1 && answer171 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer171 == 0) {
                                            System.out.println(answer171 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer171 = sc.nextInt();
                                        }
                                    }

                                    if (answer171 == 1) { // 인사한다
                                        System.out.println("머쓱하게 친구들과 인사를 나누는 백수 오윤환, 친구들도 머쓱한지 어색한 인사를 건넨다." +
                                                "\n카페에서 계속 공부를 하다가 집에 돌아온 백수 오윤환, 아무래도 당분간 그 카페에 공부하러 가지 않을 거 같다." +
                                                "\n집에 오자 긴장이 풀렸는지 공부를 더 하지 않고 뒹굴거리며 시간을 보내는 백수 오윤환. 하루빨리 마음을 다잡길 바란다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    } else { // 못알아본척한다
                                        System.out.println("친구들과 눈이 마주쳤지만 왠지모르게 모른척이 하고싶은 백수 오윤환, 시선을 회피하고 황급히 집으로 돌아간다.");
                                        System.out.println("황급히 집으로 돌아온 백수 오윤환, 스스로 왜 도망치듯 집에 왔는지 생각을 해보니 자신의 상황이 부끄럽다는 생각이 있었던 거 같다." +
                                                "\n왠지모를 슬픔과 분노가 올라오는 마음을 다잡고 하루종일 공부를 하며 시간을 보낸다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    }
                                }
                                ...
                                if (answer69 == 1) { // 알고리즘
                                    ...
                                    System.out.println("오랜만에 학원에서 공부할 떄만큼 집중력을 발휘하는 백수 오윤환, 점심식사도 건너 뛰고 계속해서 공부를 한다.");
                                    System.out.println("\nQ.계속해서 공부를 하는 백수 오윤환, 이제야 조금 배가 고픈 것 같다. 어떻게 배를 채울까?" +
                                            "\n1.카페에서 빵 먹기    2.집에 돌아가 밥 먹기");

                                    int answer172 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer172 >= 1 && answer172 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer172 == 0) {
                                            System.out.println(answer172 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer172 = sc.nextInt();
                                        }
                                    }

                                    if (answer172 == 1) { // 카페에서 빵 먹기
                                        System.out.println("카페에서 파는 빵을 사먹으며 대충 끼니를 해결하는 백수 오윤환, 몸이 조금 힘든 것 같지만 계속해서 공부를 한다." +
                                                "\n공부를 하던 중 체력의 한계가 찾아온 백수 오윤환, 최근 공부하는 습관이 없어져서인지 더이상은 무리라는 것을 느끼고 집으로 돌아가 쉰다." +
                                                "\n내일 부터는 체력운동도 병행하면서 공부를 해야겠다는 생각을 하며 휴식을 취하고 하루를 마무리한다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    } else { // 집에 돌아가 밥 먹기
                                        System.out.println("더이상은 못버틸 것 같은 체력의 한계를 느낀 백수 오윤환, 집으로 돌아가 때마침 엄마가 차려둔 저녁을 먹는다." +
                                                "\n저녁을 먹고 잠시 누웠는데 그대로 잠들어버린 백수 오윤환, 아무래도 장기간 운동도 안하고 공부하는 습관도 다 사라져서 쉽지가 않은 것 같다." +
                                                "\n꾸준히 그리고 건강하게 취준생활을 하기 위해서는 꾸준한 체력관리와 공부습관임을 다시한번 느낄 수 있었던 하루다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로젝트 종료
                                    ...
                                    System.out.println("강의의 몰입도가 굉장히 높아서인지 장시간 집중해서 공부하는 백수 오윤환, 점심식사를 건너 뛰 계속해서 공부를 한다.");
                                    System.out.println("\nQ.공부를 하다가 체력의 한계를 느낀 백수 오윤환. 집으로 돌아왔는데 도저히 아무것도 할 수가 없는 상태다. 어떻게 할까?" +
                                            "\n1.일찍 잔다    2.밥을 먹고 공부를 다시 한다");

                                    int answer173 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer173 >= 1 && answer173 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer173 == 0) {
                                            System.out.println(answer173 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer173 = sc.nextInt();
                                        }
                                    }

                                    if (answer173 == 1) { // 일찍 잔다
                                        System.out.println("독감으로 고생을 했던 백수 오윤환, 아직 몸이 완전히 회복되지 않았나보다. 집에 오자마자 옷도 갈아입지 않고 그대로 침대에 쓰러져 잠든다." +
                                                "\n무엇을 하든지 건강이 최우선임을 다시한번 깨달을 수 있는 하루였다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료

                                    } else { // 밥을 먹고 공부를 다시 한다
                                        System.out.println("몸상태가 이상함을 느낀 백수 오윤환, 일단 밥을 먹고 조금 더 힘을 내서 공부를 하기로 마음을 먹는다." +
                                                "\n엄마가 저녁을 준비하는 동안 기다리는데, 그대로 기절잠을 해버리는 백수 오윤환, 아무래도 독감의 여파로 체력이 많이 떨어진 거 같다." +
                                                "\n오늘은 푹 쉬고 내일부터 차근차근 다시 시작하면 되니 조급해하지 말자!" +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                    ...
                    System.out.println("\nQ.부지런한 하루를 보내기 위해 무엇을 할지 고민하는 백수 오윤환, 무엇을 할까요?" +
                            "\n1.아침식사");
                        ...
                        if (answer15 == 1) { // 집밥 먹기
                            ...
                            if (answer34 == 1) { // 컴포즈커피
                                ...
                                if (answer70 == 1) { // 사간다
                                    ...
                                    System.out.println("\nQ.맛있게 디저트를 먹은 백수 오윤환 오늘은 무엇을 할까?" +
                                            "\n1.집에서 쉬기    2.집안일만 하기");

                                    int answer174 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer174 >= 1 && answer174 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer174 == 0) {
                                            System.out.println(answer174 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer174 = sc.nextInt();
                                        }
                                    }

                                    if (answer174 == 1) { // 집에서 쉬기
                                        System.out.println("오늘은 아무것도 하고싶지 않은 백수 오윤환, 지난 날 알바의 후유증인지 집에 오자마자 다시 잠을 잔다.");
                                        System.out.println("\nQ.잠들었던 백수 오윤환, 정신을 차려보니 밖은 어두컴컴하다. 휴대폰으로 시간을 확인해보는 백수 오윤환, 현재 시간은?" +
                                                "\n1.오후 8시    2.오후 5시");

                                        int answer175 = sc.nextInt();

                                        for (; ; ) {

                                            if (answer175 >= 1 && answer175 <= 2) {
                                                break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                            } else if (answer175 == 0) {
                                                System.out.println(answer175 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                sc.close();
                                                return;
                                            } else {
                                                System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                answer175 = sc.nextInt();
                                            }
                                        }

                                        if (answer175 == 1) { // 오후 8시
                                            System.out.println("밤낮이 바뀌는 야간 알바와 원래 머리만 대면 잘 자는 성향이 더해져 오후 8시까지 꿀잠을 잔 백수 오윤환." +
                                                    "\n이렇게 된 거 그냥 하루종일 잠이나 자고 내일부터 열심히 살아야겠다는 말도 안되는 생각을 하면서 다시 잠을 잔다..." +
                                                    "\n허무하지만 실제로 있던 일이다. 반성하자" +
                                                    "\n-THE END-");
                                            sc.close(); // 프로그램 종료

                                        }
                                        else { // 오후 5시
                                            System.out.println("시간을 확인해보니 해가 뉘엿뉘엿 지는 오후 5시다. 이것저것 먹자마자 잠을 잤던 터라 배는 안 고픈 백수 오윤환." +
                                                    "\n어차피 쉬기로 했던 오늘이고 이왕 이렇게 된 거 트위치나 실컷 보다가 다시 잠든다... 놀랍게도 실화다." +
                                                    "\n반성하자 오윤환" +
                                                    "\n-THE END-");
                                            sc.close(); // 프로그램 종료
                                        ...
                                        System.out.println("오늘은 집에 부모님이 계시지 않아 혼자서 집안일을 다 해야하는 백수 오윤환.");
                                        System.out.println("오늘 기상 후부터 계속 감기기운이 있는 거 같던 백수 오윤환, 시간이 지날수록 점점 몸의 상태가 이상하다." +
                                                "\n최근 독감이 유행이라는 말에 병원에 가보는 백수 오윤환, 독감 확진을 받자마자 집에 돌아와 아무것도 하지 못한채 앓아 눕는다." +
                                                "\n백수 오윤환은 그렇게 5일을 골골대며 아무것도 하지 못한다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    ...
                                    System.out.println("\nQ.최근 독감에 걸려 5일을 앓아 누웠던 백수 오윤환은 그동안 하지 못했던 공부를 하려고 책상에 앉는다 어떤 공부를 할까?" +
                                            "\n1.알고리즘    2.자바의 정석");

                                    int answer176 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer176 >= 1 && answer176 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer176 == 0) {
                                            System.out.println(answer176 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer176 = sc.nextInt();
                                        }
                                    }

                                    if (answer176 == 1) { // 알고리즘
                                        System.out.println("쉬는 동안 그새 많이 까먹어버린 알고리즘, 오늘은 지난 날 공부했던 것을 복습하고 새로운 문제를 풀면서 공부를 하려고 계획을 세운 백수 오윤환.");
                                        System.out.println("몇시간 공부를 하니 금방 체력이 다 떨어진 백수 오윤환, 아직 몸이 완전히 회복되지 않았다. 이를 핑계로 스스로 합리화하며 휴식을 취하는 백수 오윤환" +
                                                "\n오늘은 공부를 조금이라도 했다는 것을 되뇌이며 하루종일 아무것도 하지 않은채 누워서 사간먼 보낸다." +
                                                "\n-THE END-");
                                        sc.close(); // 프로그램 종료
                                    }
                                    else { // 자바의 정석
                                        System.out.println("오랜만에 문법공붑를 하면서 기본기를 다지려는 백수 오윤환, 예전에 사두었던 자바정석 책을 꺼내어 공부를 시작한다.");
                                        System.out.println("\nQ.오랜만에 공부를 하는데다가 기초 문법들을 다시 훑어보니 상당부분 까먹은 것이 많다. 책에 있는 예제들을 풀어볼지 고민하는 백수 오윤환, 어떻게 할까?" +
                                                "\n1.풀어본다    2.풀지 않고 알고리즘 공부를 한다");

                                        int answer177 = sc.nextInt();

                                        for (; ; ) {

                                            if (answer177 >= 1 && answer177 <= 2) {
                                                break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                            } else if (answer177 == 0) {
                                                System.out.println(answer177 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                sc.close();
                                                return;
                                            } else {
                                                System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                answer177 = sc.nextInt();
                                            }
                                        }

                                        if (answer177 == 1) { // 풀어본다
                                            System.out.println("기초부터, 기본기 부터 탄탄히 다지는게 좋다고 생각을 하며 문법마다 한문제씩 골라서 풀어보는 백수 오윤환, 생각보다 어려문 문제 난이도에 당황하지만 끝까지 붙잡고 풀어본다." +
                                                    "\n결국 풀리지 않은 문제는 해설을 참고하여 다시 공부하고, 스스로 푼 문제는 다시한번 점검하며 더 나은 방법이 있을지 고민해보며 공부를 한다." +
                                                    "\n최근 독감에 걸려서 몸상태가 온전하지 않은 백수 오윤환은 어느정도 공부를 한 뒤 마무리하고 점차 공부량을 늘려가기로 결심한다. 그렇게 백수 오윤환의 하루는 속절없이 지나간다." +
                                                    "\n-THE END-");
                                            sc.close(); // 프로젝트 종료

                                        }
                                        else { // 풀지 않고 알고리즘 공부를 한다
                                            System.out.println("기본개념을 파는 것도 좋지만 알고리즘 공부를 하며 자연스레 체득했던 것이 떠오른 백수 오윤환, 노선을 틀어 프로그래머스에서 낮은 단계의 알고리즘 문제들 중" +
                                                    "\n직접 풀지 못했던 문제들을 다시한번 풀어보며 공부한다. 독감의 여파로 몸상태가 아직 좋지 않지만 끝까지 나름대로 열심히 공부한 백수 오윤환." +
                                                    "\n저녁시간 즈음이 되어서 공부를 마무리하고 휴식을 취한다." +
                                                    "\n-THE END-.");
                                            sc.close(); // 프러그램 종료
                                ...
                                if (answer71 == 1) { // 사간다
                                    ...
                                    int answer178 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer178 >= 1 && answer178 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        } else if (answer178 == 0) {
                                            System.out.println(answer178 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        } else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer178 = sc.nextInt();
                                        }
                                    }

                                    if (answer178 == 1) { // 집에서 쉬기
                                        System.out.println("오늘은 아무것도 하고싶지 않은 백수 오윤환, 지난 날 알바의 후유증인지 집에 오자마자 다시 잠을 잔다.");
                                        System.out.println("\nQ.잠들었던 백수 오윤환, 정신을 차려보니 밖은 어두컴컴하다. 휴대폰으로 시간을 확인해보는 백수 오윤환, 현재 시간은?" +
                                                "\n1.오후 8시    2.오후 5시");

                                        int answer179 = sc.nextInt();

                                        for (; ; ) {

                                            if (answer179 >= 1 && answer179 <= 2) {
                                                break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                            } else if (answer179 == 0) {
                                                System.out.println(answer179 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                sc.close();
                                                return;
                                            } else {
                                                System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                answer179 = sc.nextInt();
                                            }
                                        }

                                        if (answer179 == 1) { // 오후 8시
                                            System.out.println("밤낮이 바뀌는 야간 알바와 원래 머리만 대면 잘 자는 성향이 더해져 오후 8시까지 꿀잠을 잔 백수 오윤환." +
                                                    "\n이렇게 된 거 그냥 하루종일 잠이나 자고 내일부터 열심히 살아야겠다는 말도 안되는 생각을 하면서 다시 잠을 잔다..." +
                                                    "\n허무하지만 실제로 있던 일이다. 반성하자" +
                                                    "\n-THE END-");
                                    ...
                                    int answer180 = sc.nextInt();

                                    for (; ; ) {

                                        if (answer180 >= 1 && answer180 <= 2) {
                                            break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                        }
                                        else if (answer180 == 0) {
                                            System.out.println(answer180 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                            sc.close();
                                            return;
                                        }
                                        else {
                                            System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                            answer180 = sc.nextInt();
                                        }
                                    }
                                    ...
                                    if (answer180 == 1) { // 알고리즘
                                        ...
                                        int answer181 = sc.nextInt();

                                        for (; ; ) {

                                            if (answer181 >= 1 && answer181 <= 2) {
                                                break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                            } else if (answer181 == 0) {
                                                System.out.println(answer181 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                sc.close();
                                                return;
                                            } else {
                                                System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                answer181 = sc.nextInt();
                                            }
                                        }
                    ...
                    if (answer11 == 1) { // 집밥
                        ...
                        if (answer22 == 1) { // 너구리
                            ...
                            if (answer48 == 1) { // LP감상
                                ...
                                System.out.println("\nQ.첫 번째로 들을 앨범을 고르는 백수 오윤환, 늘 시작은 R&B soul로 고르는데 두 개의 앨범이 눈에 들어온다. 어떤 앨범을 들을까?" +
                                        "\n1.Maxwell의 1집    2.Michael Jackson의 5집");

                                int answer99 = sc.nextInt();

                                for (; ; ) {

                                    if (answer99 >= 1 && answer99 <= 2) {
                                        break; // 1이상 3이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                    } else if (answer99 == 0) {
                                ...
                                if (answer99 == 1) { // Maxwell의 1집
                                    ...
                                    if (answer101 == 1) { // 노래 디깅
                                        ...
                                        if (answer102 == 1) { // 유튜브 뮤직
                                            ...
                                            System.out.println("\nQ.이번달 까지만 유튜브뮤직을 이용하기로 결심한 백수 오윤환, 음악을 디깅하던 중 플레이리스트 정리까지 할까 고민이 된다. 어떻게 할까?" +
                                                    "\n1.정리한다    2.냅둔다");

                                            int answer158 = sc.nextInt();

                                            for (; ; ) {

                                                if (answer158 >= 1 && answer158 <= 2) {
                                                    break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                                } else if (answer158 == 0) {
                                                    System.out.println(answer158 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                    sc.close();
                                                    return;
                                                } else {
                                                    System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                    answer158 = sc.nextInt();
                                                }
                                            }

                                            if (answer158 == 1) { // 정리한다
                                                System.out.println("최근 바쁜 일상을 보내느라 못했던 플레이리스트 정리를 하는 백수 오윤환, 음악을 워낙 좋아하다보니 직접 만든 플레이리스트만 듣고 재생되는 곡의 순서마저 신경을 쓰며 관리한다." +
                                                        "\n만들어둔 플레이리스트만 10개가 넘고 총 곡의 갯수는 3000곡이 넘는다. 플레이리스트 정리를 하는 백수 오윤환, 상당한 시간이 걸린다.");
                                                System.out.println("자주 듣는 곡과 아닌 곡 그리고 장르별로 플레이리스트를 정리하는 백수 오윤환, 수십 수백곡들의 흐름까지 신경을 써서 정리하기 때문에 상당한 시간을 투자하는 백수 오윤환이다." +
                                                        "\n한번 제대로 정리하면 한동안 신경쓰지 않아도 돼서 오늘도 심혈을 기울여 정리하느라 자기 전까지 플레이리스트만 정리한다." +
                                                        "\n누가 보면 직업이 이쪽인줄 알겠다... 오늘은 취미생활만 하다가 하루가 끝났다." +
                                                        "\n-THE END-");
                                                sc.close(); // 프로그램 종료

                                            } else { // 냅둔다
                                                System.out.println("정리하고싶지만 돌이키기엔 너무 멀리 와버렸다. 안 그래도 오래걸리는 플레이리스트 정리인데, 이미 눈덩이 처럼 불어난 무자비한 플레이리스트를 보니 막막하다. 그리고 조만간 애플뮤직으로 갈아탈거니까 그냥 두기로 한다.");
                                                System.out.println("플레이리스트 정리를 하지 않았지만 디깅한 음악들로 새로운 플레이리스트를 만들고 있는 백수 오윤환..." +
                                                        "\n수십 수백곡들의 흐름까지 신경을 써서 정리하기 때문에 플레이리스트를 만들 때면 상당한 시간을 투자한다. 한번 제대로 시작하면 몇시간이고 마음에 들 때까지 만들기 때문에" +
                                                        "\n오늘 하루는 플레이리스트를 만들다가 다 지나가버린다. 누가 보면 직업이 이쪽인줄 알겠다... 오늘은 취미생활만 하다가 하루가 끝났다." +
                                                        "\n-THE END-");
                                                sc.close(); // 프로그램 종료
                                            }
                                        } else { // 애플 뮤직
                                            System.out.println("애플 뮤직으로 옮기는 백수 오윤환, 훨씬 많은 음원의 수와 예쁜 인터페이스 그리고 다양한 기능을 제공하는 애플 뮤직이 딥하게 음악을 듣는 백수 오윤환에게 더 합리적인 것 같다.");
                                            System.out.println("\nQ.애플 뮤직으로 옮긴 백수 오윤환, 새롭게 플레이리스트를 구성하려고 한다. 장르별로 만들지 아니면 주로 듣는 곡과 아닌 곡으로 구분할지 고민이 된다. 어떻게 할까?" +
                                                    "\n1.장르별 구분    2.스트리밍 빈도수로 구분");

                                            int answer159 = sc.nextInt();

                                            for (; ; ) {

                                                if (answer159 >= 1 && answer159 <= 2) {
                                                    break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                                } else if (answer159 == 0) {
                                                    System.out.println(answer159 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                    sc.close();
                                                    return;
                                                } else {
                                                    System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                    answer159 = sc.nextInt();
                                                }
                                            }

                                            if (answer159 == 1) { // 장르별로 구분
                                                System.out.println("장르별로 구분을해서 플레이리스트를 새로 구성하는 백수 오윤환, 플레이리스트를 만들 때면 수십 수백곡들의 흐름까지 신경을 써서 만들기 때문에 상당한 시간을 투자하는 백수 오윤환이다." +
                                                        "\n한번 제대로 만들어두면 몇년이고 유지가 가능해서 오늘도 심혈을 기울여 구성하느라 자기 전까지 플레이리스트만 만든다." +
                                                        "\n누가 보면 직업이 이쪽인줄 알겠다... 오늘은 취미생활만 하다가 하루가 끝났다." +
                                                        "\n-THE END-");
                                                sc.close(); // 프로그램 종료

                                            } else { // 스트리밍 빈도수로 구분
                                                System.out.println("스트리밍 빈도수로 구분을해서 플레이리스트를 새로 구성하는 백수 오윤환, 플레이리스트를 만들 때면 수십 수백곡들의 흐름까지 신경을 써서 만들기 때문에 상당한 시간을 투자하는 백수 오윤환이다." +
                                                        "\n한번 제대로 만들어두면 몇년이고 유지가 가능해서 오늘도 심혈을 기울여 구성하느라 자기 전까지 플레이리스트만 만든다." +
                                                        "\n누가 보면 직업이 이쪽인줄 알겠다... 오늘은 취미생활만 하다가 하루가 끝났다." +
                                                        "\n-THE END-");
                                                sc.close(); // 프로그램 종료
                                        ...
                                        if (answer103 == 1) { // 5강
                                            ...
                                            System.out.println("\nQ.꼼꼼히 공부를 하다보니 시간은 많이 흘렀고 마지막 7강을 듣지 못해다. 어떻게 할까?" +
                                                    "\n1.끝까지 한다    2.내일을 위해 잔다");

                                            int answer157 = sc.nextInt();

                                            for (; ; ) {

                                                if (answer157 >= 1 && answer157 <= 2) {
                                                    break; // 1이상 2이하의 보기 선택시 반복 벗어나 다음 코드 실행
                                                } else if (answer157 == 0) {
                                                    System.out.println(answer157 + "을(를) 입력하셨습니다. 프로그램을 종료합니다.");
                                                    sc.close();
                                                    return;
                                                } else {
                                                    System.out.println("⚠︎알림: 보기에 제시 되어진 숫자만 입력해주세요.");
                                                    answer157 = sc.nextInt();
                                                }
                                            }

                                            if (answer157 == 1) { // 끝까지 한다
                                                System.out.println("남자가 칼을 빼들었으면 무라도 베어야지, 남은 강의까지 보고 직접 적용하여 공부하는 백수 오윤환, 공부를 다 마치자마자 침대에 누워 쓰러지듯이 잠든다." +
                                                        "\n과연 내일은 일찍 일어날 수 있을지..." +
                                                        "\n-THE END-");
                                                sc.close(); // 프로젝트 종료
                                                ...
                                                System.out.println("이미 시간도 많이 늦었고 졸음이 몰려오기 때문에 공부를 하더라도 제대로 할 수가 없을 거 같다. 내일은 오늘보다 더 일찍 일어나 부지런한 삶을 살기위해 잠을 청하는 백수 오윤환" +
                                                        "\n-THE END-");
                                                sc.close(); // 프로그램 종료
